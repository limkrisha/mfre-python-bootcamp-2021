...
☑ Can open the uploaded Google Colab notebook (.ipynb) file to fill in - sample [here](https://colab.research.google.com/drive/1PEPk-bhW0c9f2VizQ0Fp2OrvxQd_LLvp#scrollTo=qzo7pyYtr7LI)
...
We can use a `for` loop to access the elements in a list or other Python data structure one at a time:
...
```{python}
data = {'canada': {'gdp': 44100, 'carbon': 15.3}, 'usa': {'gdp': 55700, 'carbon': 16.6}, 'china': {'gdp': 16200, 'carbon': 7.06}}
...
- Create one or more Python "dictionaries" for all data in the above table
